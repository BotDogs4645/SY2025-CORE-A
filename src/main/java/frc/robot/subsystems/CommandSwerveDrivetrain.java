...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
	 ...
	 *
	 * @param sample
	 *            Sample along the path to follow
	 */
	public void followTrajectory(SwerveSample sample) {
		...
		ChassisSpeeds speeds = new ChassisSpeeds(
				...
				sample.vy + ChoreoConstants.yController.calculate(pose.getY(), sample.y), sample.omega
						+ ChoreoConstants.headingController.calculate(pose.getRotation().getRadians(), sample.heading));

		// Apply the generated speeds
		setControl(m_pathApplyFieldSpeeds.withSpeeds(speeds).withWheelForceFeedforwardsX(sample.moduleForcesX())
				.withWheelForceFeedforwardsY(sample.moduleForcesY()));
	}

	public AutoFactory createAutoFactory(TrajectoryLogger<SwerveSample> trajLogger) {
		return new AutoFactory(() -> getState().Pose, this::resetPose, this::followTrajectory, true, this, trajLogger);
	}
}