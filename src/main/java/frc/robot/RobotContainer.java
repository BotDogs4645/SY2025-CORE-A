...
public class RobotContainer {
        ...
        private final CommandBuilder.Vision visionBuilder = commandBuilder.new Vision();
        ...
        private void configureBindings() {
                ...
                joystick.y().onTrue(visionBuilder.driveToTag("limelight", drivetrain));
        ...
        public Command firstPath() {
                return Commands.sequence(
                                new InstantCommand(() -> drivetrain
                                                .resetPose(Choreo.loadTrajectory("firstpath").get()
                                                                .getInitialPose(false).orElse(null))),
        ...
        public Command secondPath() {
                return Commands.sequence(
                                new InstantCommand(() -> drivetrain
                                                .resetPose(Choreo.loadTrajectory("secondpath").get()
                                                                .getInitialPose(false).orElse(null))),
        ...
        public Command dathPath() {
                return Commands.sequence(
                                new InstantCommand(() -> drivetrain
                                                .resetPose(Choreo.loadTrajectory("dath").get().getInitialPose(false)
                                                                .orElse(null))),
