...
public class Constants {
  ...
  public class EndEffectorConstants {
    ...
    public static final Rotation2d level1 = Rotation2d.fromDegrees(-145); 
    public static final Rotation2d level2 = Rotation2d.fromDegrees(-145); 
    public static final Rotation2d level3 = Rotation2d.fromDegrees(-145); 
    public static final Rotation2d level4 = Rotation2d.fromDegrees(-180); 
    public static final Rotation2d intake = Rotation2d.fromDegrees(-102); 
